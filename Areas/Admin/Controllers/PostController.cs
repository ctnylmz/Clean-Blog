...
namespace Clean_Blog.Areas.Admin.Controllers
{
    ...
    public class PostController : Controller
    {
        ...
        public PostController(UserManager<IdentityUser> userManager, SignInManager<IdentityUser> signInManager, CleanBlogContext context, IHttpContextAccessor httpContextAccessor)
        {
