...
namespace Clean_Blog.Areas.Admin.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public HomeController(UserManager<IdentityUser> userManager, SignInManager<IdentityUser> signInManager, ApplicationDbContext context, IHttpContextAccessor httpContextAccessor)
        {
